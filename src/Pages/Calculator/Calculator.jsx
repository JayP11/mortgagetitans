    ...
    <>
      ...
      <div className="MortgageCalc_main">
        ...
        <div className="Form_main">
          <h2 className="calc_head_main">Mortgage Repayment Calculator</h2>
          <div
            style={{
              display: "flex",
          ...
          >
            <div className="Calc_input_main" style={{ padding: "0 0.5rem" }}>
              ...
              {homeValueError && (
                <p style={{ margin: "0px", color: "red" }}>{homeValueError}</p>
              )}
            </div>
            <div className="Calc_input_main" style={{ padding: "0 0.5rem" }}>
              <label>Deposit:</label>
          ...
          <div>
            <p style={{ margin: "0px", fontWeight: "700", color: "red" }}>
              Disclaimer:{" "}
            </p>
